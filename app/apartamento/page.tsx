  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-primary-600 to-primary-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-50">
            Tudo que você precisa saber para se sentir em casa
          </p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
              <p className="font-bold text-green-900 mb-1">✅ Check-in</p>
              <p className="text-gray-700">{apartmentInfo.checkIn}</p>
            </div>
            <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
              <p className="font-bold text-red-900 mb-1">🚪 Check-out</p>
        ...
        {/* Address */}
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          <h3 className="font-bold text-lg text-gray-900 mb-2">📍 Endereço Completo</h3>
          <p className="text-gray-700 text-lg">{apartmentInfo.address}</p>
        </div>

        {/* House Rules */}
        <InfoSection icon="📋" title="Regras da Casa" defaultOpen>
        ...
        {/* Appliances */}
        <InfoSection icon="⚡" title="Como Usar os Eletrodomésticos">
        ...
        {/* Troubleshooting */}
        <InfoSection icon="🔧" title="Resolução de Problemas">
          <div className="space-y-6">
